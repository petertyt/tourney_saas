...
import { ArrowLeft, Github, Chrome, Shield, Trophy } from "lucide-react";
    ...
    <div className="min-h-screen bg-dark-500 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative">
          <div className="absolute inset-0 bg-gradient-to-br from-success-500/10 via-primary-500/10 to-accent-500/10"></div>
            ...
            <div className="text-center text-white">
              ...
              <div className="gaming-card p-8 max-w-sm mx-auto">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  Access your tournaments, manage teams, and continue your
                  journey.
                </p>
              </div>
            </div>
